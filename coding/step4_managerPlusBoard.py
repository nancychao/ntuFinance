...
#     industry = 'M2800 金融業'
    ...
    manager = pd.read_excel(dataPath + '2_高階經理人_'+industry+'_'+mmdd+'.xlsx') 
    board = pd.read_excel(dataPath + '3_獨立董事_'+industry+mmdd+'.xlsx') 
...
df.to_excel(dataPath + '4_經理人+獨董_'+mmdd+'.xlsx',
